                        ...
                        <div className="card-body">
                            <div className="direct-chat-messages">
                                <div className="direct-chat-msg">
                                    ...
                                    <img className="direct-chat-img" src="assets/dist/img/user1-128x128.jpg" aria-hidden alt="message user image" />
                                ...
                                <div className="direct-chat-msg right">
                                    ...
                                    <img className="direct-chat-img" src="assets/dist/img/user3-128x128.jpg" aria-hidden alt="message user image" />
                                    <div className="direct-chat-text">
                            ...
                            <div className="direct-chat-contacts">
                                <ul className="contacts-list">
                                    <li>
                                        <a href="/#">
                                            <img className="contacts-list-img" src="assets/dist/img/user1-128x128.jpg" aria-hidden alt="User Avatar" />
                            ...
                            <small className="contacts-list-date float-right">2/28/2015</small>
                                    ...
                                    <li>
                                        <a href="/#">
                                            <img className="contacts-list-img" src="assets/dist/img/user7-128x128.jpg" aria-hidden alt="User Avatar" />
                            ...
                            <small className="contacts-list-date float-right">2/23/2015</small>
                                    ...
                                    <li>
                                        <a href="/#">
                                            <img className="contacts-list-img" src="assets/dist/img/user3-128x128.jpg" aria-hidden alt="User Avatar" />
                            ...
                            <small className="contacts-list-date float-right">2/20/2015</small>
                                    ...
                                    <li>
                                        <a href="/#">
                                            <img className="contacts-list-img" src="assets/dist/img/user5-128x128.jpg" aria-hidden alt="User Avatar" />
                            ...
                            <small className="contacts-list-date float-right">2/10/2015</small>
                                    ...
                                    <li>
                                        <a href="/#">
                                            <img className="contacts-list-img" src="assets/dist/img/user6-128x128.jpg" aria-hidden alt="User Avatar" />
                            ...
                            <small className="contacts-list-date float-right">1/27/2015</small>
                                    ...
                                    <li>
                                        <a href="/#">
                                            <img className="contacts-list-img" src="assets/dist/img/user8-128x128.jpg" aria-hidden alt="User Avatar" />
                        ...
                        <div className="card-body">
                            <ul className="todo-list" data-widget="todo-list">
                                ...
                                <li>
                                    ...
                                    <div className="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="" name="todo2" id="todoCheck2" defaultChecked />
