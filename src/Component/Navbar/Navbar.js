    ...
    return (
        <aside className="main-sidebar sidebar-dark-primary elevation-4">
            <a href="index3.html" className="brand-link">
                <img src="assets/dist/img/AdminLTELogo.png" aria-hidden alt="AdminLTE Logo" className="brand-image img-circle elevation-3" />
            ...
            <div className="sidebar">
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div className="image">
                        <img src="assets/dist/img/user2-160x160.jpg" aria-hidden className="img-circle elevation-2" alt="User Image" />
                    </div>
                    <div className="info">
